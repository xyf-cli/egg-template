...
module.exports = app => {
  ...
  // router.post('/productFile', jwt, controller.productFile.multiUpload);
  // router.get('/productFile', jwt, controller.productFile.index);
  // router.delete('/productFile/:id', jwt, controller.productFile.destroy);
